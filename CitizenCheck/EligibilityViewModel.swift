...
class EligibilityViewModel : ObservableObject {
    ...
    init(appData : AppData) {
        ...
        let question3 = EligibilityQuestion(question:
                                                
                                                
                                                """
Do any of these apply to you:
1) I am married to a U.S. citizen
2) I am an asylee who has had lawful permanent residence for four years or more
3) I am a refugee who has been in the U.S. for five years or more (with or without lawful permanent residency)
4) I am a current or former military member or spouse of a military member who died during active duty in the U.S. Armed Forces
""",
                                            options:["Yes", "No"], id:3)
